...
**[View Live Site Deployed on Render](https://mysheltertree.com) | [GitHub Repo](https://github.com/Marrtinerz/sheltertree)**
...
- **Performance:** Eliminated N+1 query bottlenecks using Django’s `OuterRef` and `Subquery`, and achieved sub-100ms UI updates using HTMX instead of a heavy JavaScript SPA.
...
- **Automation:** Built automated state machines and custom batch-processing scripts using yield iterators to manage trip expirations and prevent memory leaks.
...
- **Certifications:**
    - [ChatGPT Prompt Engineering (DeepLearning.AI)](https://learn.deeplearning.ai/accomplishments/f9002b4a-31cf-4ceb-9aef-c7d65b1742c5?usp=sharing)
    - [Foundations of Data Structures and Algorithms (CU Boulder)](https://www.coursera.org/account/accomplishments/verify/3MRK4SV5Y4FL))
    - [Trees and Graph DSA (CU Boulder)](https://www.coursera.org/account/accomplishments/records/ILZI0FRFQEI0)
